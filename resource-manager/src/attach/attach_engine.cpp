...
std::optional<Error> AttachEngine::attach(const Group& group, const RuntimeState& state) {
...
std::optional<Error> AttachEngine::reattach(const Group& group, RuntimeState& state) {
    // Phase 3 implementation.
    return std::nullopt;
}
